...
echo "---------------------PROGRAMMATION SHELL. UE D'ADMIN----------------------------"
echo "--------------------------------------------------------------------------------"
echo "&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&"
echo "&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&"
echo "*********************** CHOISIR SELON L'OPTION A EXECUTER **********************"
echo "********************************************************************************"
...
echo "................................................................................"
echo "................................................................................" 
echo "...............Travail réalisé par MEIDOGO SEINBERO CHRISTOPHE 14A348FS........."
echo ".........................................L3AR..................................."
echo "................................................................................"
read -r choix
case $choix in 
...
;;
	...
	mkdir -p /home/meidogo@meidogo-Lenovo-B51-30/archive
	find /home/meidogo@meidogo-Lenovo-B51-30/ -type f -mtime 2 -print>/home/meidogo@meidogo-Lenovo-B51-30/ficmodi
	while read line
	do
	cp $line archive
	done </home/meidogo@meidogo-Lenovo-B51-30/ficmodi
	tar -czvf archive.tar.gz archive
	#mv archive.tar.gz /media/usb/*/archive.tar.gz
	mv archive.tar.gz /home/meidogo@meidogo-Lenovo-B51-30/prof/archive.tar.gz
	;;
